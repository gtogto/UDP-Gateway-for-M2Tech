...
public class ColorSeekBar extends View {
    ...
    public static int realRight;
    public static int mBarWidth;
    public static int mMaxPosition;
    private RectF mAlphaRect = new RectF();
    public static int mColorBarPosition;
    public static int mAlphaBarPosition;
    private int mDisabledColor;
    private int mBarMargin = 5;
    private int mAlphaMinPosition = 0;
    private int mAlphaMaxPosition = 255;
    private int mBarRadius;
    public static List<Integer> mCachedColors = new ArrayList<>();
    ...
    public static int pick_color_return;
